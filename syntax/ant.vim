...
syn keyword antElement display fail file filelist filename filepath fileset filesmatch filetokenizer filter
syn keyword antElement display filterchain filterreader filters filterset filtersfile fixcrlf footer for format
...
syn keyword antElement display replacestring replacetoken replacetokens replacevalue replyto report resource resources
...
syn keyword antElement display typedef union unjar untar unwar unzip uptodate url user var vbc vssadd vsscheckin
