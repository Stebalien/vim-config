...
syn keyword kotlinStatement    val var by
...
syn keyword kotlinClassMod     abstract final enum open attribute inner
syn keyword kotlinScopeDecl    public private protected internal
...
syn keyword kotlinVararg       vararg
...
if !exists("did_kotlin_syntax_inits")
    ...
    hi link kotlinVararg       Statement
